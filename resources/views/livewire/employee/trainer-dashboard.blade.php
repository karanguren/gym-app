<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 font-inter">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        
        <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white mb-10 border-b pb-4 dark:border-gray-700">
