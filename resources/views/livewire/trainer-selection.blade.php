<div class="div-principal">
    ...
    >
        <div class="md:p-8">
            ...
            <h1 class="titles-b">Selecciona tu Entrenador Personal</h1>
            ...
            <div
                class="mb-8 p-4 sm:p-6 rounded-lg shadow-lg dark:bg-gray-800 border-l-4 border-indigo-500 transition duration-300 {{ $statusClasses[$status] ?? 'bg-gray-100 text-gray-600' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($trainers as $trainerItem)
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition duration-300 p-5 flex flex-col justify-between">
                        <div>
                        ...
                        <div class="mt-4">
                            <button wire:click="openSelectionModal({{ $trainerItem->id }}, '{{ $trainerItem->name }}')"
                                @click="openModal('{{ $trainerItem->name }}')" {{-- Deshabilitar si ya hay una solicitud pendiente o ya está asignado --}}
                                ...
                                class="w-full py-2 px-4 rounded-lg font-bold text-white transition duration-300 shadow-md
                                    @if ($status === 'pending' || $trainerItem->id === $assignedTrainer?->id) bg-gray-400 cursor-not-allowed
                                    @else
            ...
            {{-- MODAL 1: CONFIRMACIÓN DE SELECCIÓN --}}

            <div x-data="{ show: @entangle('showSelectionModal') }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
                style="display: none;">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div x-show="show" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="bg-white dark:bg-gray-800 px-6 py-5">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mt-3 text-center" id="selection-title">
                            ...
                            <div class="flex justify-end space-x-3">
                                <button wire:click="closeSelectionModal" type="button"
                                ...
                                <button wire:click="selectTrainer" type="button"
            ...
            <div x-data="{ show: @entangle('showDetachModal') }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
                style="display: none;">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div x-show="show" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="bg-white dark:bg-gray-800 px-6 py-5">
                            <svg class="mx-auto h-12 w-12 text-red-600 dark:text-red-400" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
                                    d="M10.29 3.86L1.83 18a2 2 0 0 0 1.73 3h16.88a2 2 0 0 0 1.73-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
                                <line x1="12" y1="9" x2="12" y2="13" />
                                <line x1="12" y1="17" x2="12.01" y2="17" />
                            </svg>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mt-3 text-center" id="detach-title">
                                Confirmar Desvinculación</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-6 text-center">
                                ¿Estás seguro de que deseas desvincularte de tu entrenador actual? Esta acción cancelará tu
                                solicitud pendiente o removerá tu asignación aceptada.
                            </p>

                            <div class="flex justify-end space-x-3">
                                <button wire:click="closeDetachModal" type="button"
                                    class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-lg transition duration-300 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                                    No, Cancelar
                                </button>
                                <button wire:click="detachTrainer" type="button"
