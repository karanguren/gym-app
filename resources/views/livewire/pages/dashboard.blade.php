    ...
    <div class="max-w mx-auto sm:px-6 lg:px-8 ">
        <div class="md:p-8">
            ...
            @php
                ...
                // NUEVO: Intentar cargar el entrenador asignado desde el perfil del usuario
                // ASUMIMOS que Auth::user()->profile existe y tiene una relación 'assignedTrainer'.
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col justify-between border border-gray-200 dark:border-gray-700">
                    <div>
                        ...
                        @if ($assignedTrainer)
                            ...
                            <div class="flex items-center space-x-4 mb-4">
                                <img src="{{ $assignedTrainer->profile_photo_url }}" 
                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <a href="{{ route('client.routines') }}" 
                                class="w-full inline-block btn-ouline-ve">
                                    MIS RUTINAS
                                </a>
                        ...
                        @else
                            ...
                            <div class="space-y-4">
                                @foreach ($selfMadeRoutines as $routine)
                                    <div class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition duration-200 border border-l-4 border-primary flex items-center justify-between">
                    
                                        <!-- Contenido -->
                                        <a href="{{ route('routine.workout', ['routine' => $routine->id]) }}" class="flex-grow min-w-0 pr-4 group">
                                            <h3 class="text-lg font-bold text-gray-900 dark:text-white truncate group-hover:text-primary transition duration-200">{{ $routine->name }}</h3>
                                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                                Creada por ti
                                            </p>
                                            <span class="inline-flex items-center mt-2 px-3 py-1 text-xs font-medium bg-primary/20 text-primary-dark rounded-full">
                                        ...
                                        <a href="{{ route('routine.workout', ['routine' => $routine->id]) }}" class="flex-shrink-0 bg-primary hover:bg-[#5aa301] text-white p-2 rounded-full transition duration-300 shadow-lg" title="Iniciar entrenamiento">
