...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100 font-sans antialiased dark:bg-gray-900">
        ...
        <!-- Barra de Navegación Simple (Similar a welcome.blade.php) -->
        <header class="p-6 bg-white shadow-md w-full dark:bg-gray-800">
            <div class="container mx-auto flex justify-between items-center">
                <a href="{{ route('dashboard') }}" class="text-2xl font-bold text-indigo-700 dark:text-indigo-400">Panel de Control</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline-block">
                        @csrf
                        <button type="submit" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 shadow-lg dark:bg-pink-600 dark:hover:bg-pink-700">
                            Cerrar Sesión
                        </button>
                    </form>
                </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    @elseif (Auth::user()->role === 'cliente' && Auth::user()->profile && Auth::user()->profile->is_verified)
                        ...
                        <!-- Aquí irán los componentes de Livewire para Rutinas, Progreso, etc. -->
